...
**Spring Boot Starter for validation-mimetypes**
...
**validation-mimetypes-spring-boot-starter** is a Spring Boot starter that integrates **validation-mimetypes** for applications using validation-mimetypes. It provides auto-configuration, property binding, and ready-to-use beans so that applications can consume validation-mimetypes capabilities with minimal setup.

| Dimension | Description |
|---|---|
| Type | Spring Boot Starter |
| Consumers | Spring Boot applications using validation-mimetypes |
| Core Capabilities | auto-configuration, property binding, ready-to-use beans for validation-mimetypes |
| JDK | `17` |
| Coordinates | `io.github.easy4j:validation-mimetypes-spring-boot-starter:1.0.1-SNAPSHOT` |
...
|---|:---:|---|
| Auto-configuration | ✅ Stable | Registers validation-mimetypes beans automatically |
